...
export const stats = [
  ...
  { value: "1 год", label: "гарантия на всё" },
  { value: "14 дней", label: "срок производства" },
  { value: "1 мм", label: "точность замера" },
];
...
export const productionStats = [
  ...
  { value: "5 лет", label: "опыт в мебели на заказ" },
  { value: "14 дней", label: "средний срок производства" },
